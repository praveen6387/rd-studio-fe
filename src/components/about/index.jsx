        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Learn more about our passion for photography and commitment to excellence. 
            ...
            <div className="relative">
              ...
              <div className="space-y-6 mb-8">
                <p className="text-lg text-gray-600 leading-relaxed">
                  Founded in <span className="font-semibold text-indigo-600">2014</span>, RD Photo began with a simple mission: to capture authentic moments that tell meaningful stories. What started as a passion project has grown into a trusted photography studio serving clients across the region.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Our founder, a self-taught photographer with over a decade of experience, believes that every moment has the potential to become a <span className="font-semibold text-purple-600">timeless memory</span>. This philosophy drives everything we do, from our approach to lighting and composition to our commitment to customer service.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Today, we're proud to have captured thousands of special moments for families, couples, and businesses, creating images that will be cherished for generations to come.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We never compromise on quality, using the best equipment and techniques to deliver exceptional results that exceed expectations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our love for photography drives us to go above and beyond for every client and every shot, capturing moments with genuine enthusiasm.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We build genuine relationships with our clients to understand their vision and deliver personalized results that create lasting memories.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 bg-gradient-to-r from-gray-900 via-indigo-700 to-gray-900 bg-clip-text text-transparent">
              The Talented Photographers Behind RD Photo
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Meet the passionate professionals who bring creativity, skill, and dedication to every project. 
              Our team combines years of experience with fresh perspectives.
            </p>
          </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    10+ years of experience in wedding and portrait photography. Sarah's artistic vision and attention to detail create timeless images.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Specializes in corporate events and celebrations. Mike's dynamic style captures the energy and emotion of every occasion.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Expert in family and individual portrait sessions. Emma's warm personality helps clients feel comfortable and natural in front of the camera.
                  </p>
                </div>
              </div>
            </div>
