        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From intimate portraits to grand celebrations, we capture every moment with artistry and precision. Every
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Capture your special day with our comprehensive wedding photography packages. We preserve every
                    precious moment with artistic excellence.
                  </p>
                  ...
                  <Link
                    href="/gallery"
                    className="w-full bg-gradient-to-r from-rose-500 to-pink-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-rose-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block text-center"
                  >
                    Learn More
                  </Link>
                </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Professional portraits for individuals, families, and corporate needs. Let us capture your
                    personality and style beautifully.
                  </p>
                  ...
                  <Link
                    href="/gallery"
                    className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block text-center"
                  >
                    Learn More
                  </Link>
                </div>
            ...
            <div className="group relative">
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    From corporate events to birthday parties, we document your celebrations. Every event tells a story
                    worth preserving with great care.
                  </p>
                  ...
                  <Link
                    href="/gallery"
                    className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-amber-600 hover:to-yellow-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block text-center"
                  >
                    Learn More
                  </Link>
                </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-6 mb-8">
                <p className="text-lg text-gray-600 leading-relaxed">
                  With over <span className="font-semibold text-indigo-600">10 years of experience</span> in
                  professional photography, we specialize in capturing authentic moments that tell your unique story.
                  Our passion for photography drives us to create images that will be cherished for generations.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  From intimate family portraits to grand wedding celebrations, we approach every shoot with{" "}
                  <span className="font-semibold text-purple-600">
                    creativity, professionalism, and attention to detail
                  </span>
                  . Every moment matters, and we're here to preserve them beautifully.
                </p>
              </div>
              ...
              <Link
                href="/about"
                className="group bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block"
              >
                <span className="flex items-center gap-2">
                  Learn More About Us
                  <svg
            ...
            <div className="relative">
              ...
              <div className="relative group">
                <div className="relative aspect-[4/5] rounded-3xl shadow-2xl overflow-hidden">
                  <Image src="/about5.jpg" alt="About RD Studio" fill className="object-cover" priority />
                  {/* Subtle overlay */}
