...
import { Image, Video, CheckCircle2, Clock, Download, Star, ArrowRight } from "lucide-react";
    ...
    <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-xl hover:shadow-2xl transition-all duration-300 lg:sticky lg:top-28">
      ...
      <div className="space-y-3">
        {statItems.map((item, index) => (
          <div
            key={index}
            className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-white rounded-xl hover:from-gray-100 hover:to-gray-50 transition-all duration-300 group"
          >
