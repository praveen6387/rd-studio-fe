          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  <p className="text-gray-300 group-hover:text-white transition-colors">rdphotography570@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  <p className="text-gray-300 group-hover:text-white transition-colors">+91 9792098570</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  <p className="text-gray-300 group-hover:text-white transition-colors">Basti, UP, India</p>
                </div>
              </div>
            </div>
          </div>
